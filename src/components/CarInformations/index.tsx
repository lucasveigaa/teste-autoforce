...
import { ContainerContent, ContainerContent1, ContainerContent2, ContainerHighlights, SubContainerHighlights } from "./styles";
          ...
          <ContainerContent2>
            ...
            <ContainerHighlights>
              <div>
                <img
                  src={iconConsumo}
                  alt="Icone de uma bomba de combustível"
                />
